...
На графиках приняты следующие условные обозначения:
    ...
    <JdbcTempl> - вставка с использованием batch-JdbcTemplate.
